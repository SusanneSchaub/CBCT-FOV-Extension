...
class TrainLoop:
    ...
    def run_loop(self):
        while (
            ...
            try:
                data = next(self.data)
                batch, cond = data["slice_gt"], data["slice"] #, data["slice_sirt"] #data["mask"]
            ...
            self.run_step(ground_truth, cond)
    ...
    def run_step(self, ground_truth, cond):

        self.forward_backward(ground_truth, cond)
